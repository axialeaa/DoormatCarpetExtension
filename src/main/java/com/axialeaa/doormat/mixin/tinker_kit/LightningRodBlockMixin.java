...
@Mixin(value = LightningRodBlock.class, priority = 1500)
public abstract class LightningRodBlockMixin {
    ...
    @ModifyArg(method = "setPowered", at = @At(value = "INVOKE", target = "Lnet/minecraft/world/World;setBlockState(Lnet/minecraft/util/math/BlockPos;Lnet/minecraft/block/BlockState;I)Z"))
    private int modifyUpdateType_setPowered(int original, @Local(argsOnly = true) BlockState state) {
    ...
    @WrapOperation(method = "setPowered", at = @At(value = "INVOKE", target = "Lnet/minecraft/world/World;scheduleBlockTick(Lnet/minecraft/util/math/BlockPos;Lnet/minecraft/block/Block;I)V"))
