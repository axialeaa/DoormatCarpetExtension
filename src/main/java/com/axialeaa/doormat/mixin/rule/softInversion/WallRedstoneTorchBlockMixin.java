...
public class WallRedstoneTorchBlockMixin {
    ...
    private boolean unpowerOnPistonExtend(boolean original, World world, BlockPos pos, BlockState state, @Local Direction direction) {
        return RedstoneUpdateBehaviour.unpowerOnPistonPowered(original, world, pos, direction);
    }
