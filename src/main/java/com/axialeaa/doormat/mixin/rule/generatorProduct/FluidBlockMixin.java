...
public class FluidBlockMixin {
    ...
    private Block modifyObsidianGenProduct(Operation<Block> original) {
        return BlockIdentifierValidator.getBlockFromId(DoormatSettings.obsidianGenProduct).orElse(original.call());
    }
    ...
    private Block modifyCobbleGenProduct(Operation<Block> original) {
        return BlockIdentifierValidator.getBlockFromId(DoormatSettings.cobblestoneGenProduct).orElse(original.call());
    }
    ...
    private Block modifyBasaltGenProduct(Operation<Block> original) {
        return BlockIdentifierValidator.getBlockFromId(DoormatSettings.basaltGenProduct).orElse(original.call());
    }
