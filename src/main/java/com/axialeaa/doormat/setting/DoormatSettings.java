package com.axialeaa.doormat.setting;
...
public class DoormatSettings {
    ...
    @Rule( categories = { TINKERING, DOORMAT } )
    public static ChiseledBookshelfFullnessSignalMode chiseledBookshelfFullnessSignal = ChiseledBookshelfFullnessSignalMode.FALSE;
    ...
    public static CarouselTooltipsMode compactBannerTooltips = CarouselTooltipsMode.FALSE;

    @Rule( categories = { CLIENT, TOOLTIP, DOORMAT } )
    public static CarouselTooltipsMode compactEnchantTooltips = CarouselTooltipsMode.FALSE;

    @Rule( categories = { CLIENT, TOOLTIP, DOORMAT } )
    public static CompactPotTooltipsMode compactPotTooltips = CompactPotTooltipsMode.FALSE;

    @Rule( categories = { CLIENT, TOOLTIP, DOORMAT } )
    public static boolean compactTemplateTooltips = false;

    @Rule( categories = { CLIENT, TOOLTIP, DOORMAT } )
    public static CompactTrimTooltipsMode compactTrimTooltips = CompactTrimTooltipsMode.FALSE;
    ...
    public static PeacefulMonsterSpawningMode peacefulMonsterSpawning = PeacefulMonsterSpawningMode.FALSE;
...
//    public static String portalWidth = "2-21";
    ...
    @Rule( categories = { CLIENT, PARITY, DOORMAT }, conditions = ReachAroundBridgingCondition.class )
    ...
    @Rule( categories = { CREATIVE, DOORMAT } )
    public static TrialSpawnerEntityRequirementMode trialSpawnerEntityRequirement = TrialSpawnerEntityRequirementMode.SURVIVAL_PLAYERS;
